            ...
            <Card className="custom-card">
                <Card.Body>
                    <div className="float-end">
                        <SpkTooltips placement="top" title="Add to Wishlist">
                            <Link to="#!" className="avatar avatar-rounded bg-primary-transparent avatar-sm">
                                <span><i className="ri-heart-line align-middle fs-14"></i></span>
                            </Link>
                        </SpkTooltips>

                        {obj.showTooltip ? (
                            <SpkTooltips placement="top" title="Share this company">
                                <Link to="#!" className="avatar avatar-rounded bg-primary-transparent avatar-sm ms-1">
                            ...
                            <h6 className="fw-medium mb-0 d-flex align-items-center">
                                <Link to="#!">
                                    ...
                                    <SpkTooltips placement="top" title="Verified company">
                                        <i className="ms-1 ri-verified-badge-fill text-secondary fs-13"></i>
                                    </SpkTooltips>
                                </Link>
                            </h6>
                ...
                <Card.Footer>
                    <div className="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <Link to="#!" className="btn-sm btn btn-wave btn-primary">
