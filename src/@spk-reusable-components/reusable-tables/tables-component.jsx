...
const SpkTablescomponent = ({ children, tableClass, Bodytag=true, headerClass, header, footerClass, footchildren, headerContent, tBodyClass, checked, showCheckbox = false, Customcheckclass, onChange }) => {
    return (
        <Fragment>
