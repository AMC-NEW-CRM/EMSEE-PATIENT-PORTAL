...
import { removeFromCart, ThemeChanger } from '../common/ui/redux/action';
...
const Header = ({ local_varaiable, ThemeChanger }) => {
  ...
  //Notification
  const img = <span className="avatar avatar-md avatar-rounded bg-primary"> <img src={face1} alt="user1" /> </span>
  const img1 = <span className="avatar avatar-md bg-primary avatar-rounded fs-20"> <i className="fe fe-shopping-cart lh-1 "></i> </span>
  const img2 = <span className="avatar avatar-md bg-orange avatar-rounded"> <img src={face10} alt="user1" /> </span>
  const img3 = <span className="avatar avatar-md bg-success avatar-rounded"> <img src={face11} alt="user1" /> </span>
            ...
            <div className="header-element">
              <div className="horizontal-logo">
                ...
                <Link to={`${import.meta.env.BASE_URL}dashboard/sales`} className="header-logo">
                  ...
                  <img src={toggledarklogo} alt="logo" className="toggle-dark" />
          ...
          <ul className="header-content-right">
            ...
            <SpkDropdown Customclass="header-element cart-dropdown" toggleas="a" Navigate='#' Svg={true} Customtoggleclass='header-link dropdown-toggle no-caret' Badgetag={true} Badgeclass='header-icon-badge' Menuclass='main-header-dropdown dropdown-menu-end'
                      ...
                      <div className="d-flex align-items-center cart-dropdown-item gap-3" key={Math.random()}>
                        <div className="lh-1">
                          <span className="avatar avatar-xl bg-primary-transparent">
                            <img src={idx.productpicture} alt="Wireless Headphones" />
                          </span>
                        </div>
                        <div className="flex-fill">
                          <div className="d-flex align-items-center justify-content-between mb-0">
                            ...
                            <div className="text-end">
                              <Link to="#!" onClick={(event) => handleDelete(idx.id, event)} className="header-cart-remove dropdown-item-close"><i className="ri-close-line"></i></Link>
              ...
              <div className={`p-3 empty-header-item border-top d-flex gap-2 align-items-center ${cartItemCount === 0 ? 'd-none' : 'd-block'}`}>
                <Link to="#!" className={`btn flex-fill btn-primary btn-wave ${cartItemCount === 0 ? 'd-none' : 'd-block'}`}>Proceed to checkout</Link>
              </div>
              <div className={`p-5 empty-item ${cartItemCount === 0 ? 'd-block' : 'd-none'}`}>
                <div className="text-center">
                  ...
                  <Link to="#!" className="btn btn-primary1 btn-wave btn-sm m-1" data-abc="true">continue shopping <i className="bi bi-arrow-right ms-1"></i></Link>
                </div>
              </div>
                    ...
                    <li className='dropdown-item' key={notification.id}>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 d-flex align-items-center justify-content-between">
                          <div>
                            <p className="mb-0 fw-medium"><Link to="#!">{notification.heading}</Link></p>
                            {notification.data}
                            <div className="fw-normal fs-10 text-muted op-8">{notification.data1}</div>
                          </div>
                          <div>
                            <Link to="#!"  className="min-w-fit-content dropdown-item-close1" onClick={() => handleRemove1(notification.id)}>
              ...
              {hasNotifications && (
                <div className="p-3 empty-header-item1 border-top">
                  <div className="d-grid">
                    <Link to="#!" className="btn btn-primary btn-wave">View All</Link>
                  </div>
                </div>
              )}
            </SpkDropdown>
            ...
            <SpkDropdown Customclass="header-element" toggleas="a" Navigate='#!' Customtoggleclass='header-link no-caret' Id="mainHeaderProfile" Imagetag={true}
              Imageclass='d-flex align-items-center avatar avatar-sm' Imagesrc={face15}
              ...
              <li><Link className="dropdown-item d-flex align-items-center" to="#!"><i className="fe fe-user p-1 rounded-circle bg-primary-transparent me-2 fs-16"></i>Profile</Link></li>
              <li><Link className="dropdown-item d-flex align-items-center" to="#!"><i className="fe fe-mail p-1 rounded-circle bg-primary-transparent me-2 fs-16"></i>Mail Inbox</Link></li>
              <li><Link className="dropdown-item d-flex align-items-center" to="#!"><i className="fe fe-database p-1 rounded-circle bg-primary-transparent klist me-2 fs-16"></i>File Manger<SpkBadge variant='primary1' Customclass="text-fixed-white ms-auto fs-9">2</SpkBadge></Link></li>
              <li><Link className="dropdown-item d-flex align-items-center" to="#!"><i className="fe fe-settings p-1 rounded-circle bg-primary-transparent ings me-2 fs-16"></i>Settings</Link></li>
              <li><Link className="dropdown-item dropdown-item d-flex align-items-center" to="#!"><i className="fe fe-help-circle p-1 rounded-circle bg-primary-transparent set me-2 fs-16"></i>Help</Link></li>
              <li><a className="dropdown-item d-flex align-items-center" href="#" onClick={(e) => {
                            e.preventDefault(); // Prevent default navigation
                            auth.signOut();
                            routeChange();
                          }}><i className="fe fe-lock p-1 rounded-circle bg-primary-transparent ut me-2 fs-16"></i>Log Out</a></li>
            </SpkDropdown>
            {/* <!-- End::header-element --> */}
