...
import Spkcardscomponent from "../../../@spk-reusable-components/reusable-dashboards/spk-cards.jsx";
                ...
                <div className="d-flex sales-picker align-items-center gap-2 flex-wrap">
                    <div className="form-group">
                        <div className="input-group">
                            ...
                            <SpkFlatpickr inputClass="form-control border-0" options={{ mode: 'range', dateFormat: "Y-m-d", static:true }} onfunChange={handleDateChange} placeholder={["2016-10-10", "2016-10-20"]} />
                        </div>
                    </div>
                            ...
                            <Card className="custom-card overflow-hidden">
                                ...
                                <Card.Body className="pt-4 px-3">
                                    ...
                                    <div id="orders" className="my-2">
                                        <Spkapexcharts chartOptions={Staticoptions} chartSeries={Staticseries} type="donut" width={"100%"} height={207} />
                                    </div>
                                </Card.Body>
                                ...
                                <SpkTablescomponent showCheckbox={true} tableClass="text-nowrap" Customcheckclass="text-center" header={[{ title: 'Customer' }, { title: 'Product' }, { title: 'Quantity', headerClassname:'text-center' }, { title: 'Amount' , headerClassname:'text-center'}, { title: 'Status' }, { title: 'date Ordered' }, { title: 'Actions' }]}>
                                    {data.map((idx) => (
                                        <tr key={Math.random()}>
                                            ...
                                            <td>
                                                <div className="btn-list">
                                                    <SpkButton Buttonvariant="success-light" Size="sm" Customclass="btn-icon me-2"><i className="ri-pencil-line"></i></SpkButton>
